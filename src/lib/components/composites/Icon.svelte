<script lang="ts">
/**
 * Icon component - Inline SVG icons (feather-style)
 */
...
const icons: Record<string, string> = {
  ...
  'thumbtack': '<path d="M12 22v-6"/><path d="M5 16h14"/><path d="M7.5 10V7l-1-1V4h11v2l-1 1v3a4 4 0 0 1 2.5 3.7V16h-14v-2.3A4 4 0 0 1 7.5 10z"/>',
